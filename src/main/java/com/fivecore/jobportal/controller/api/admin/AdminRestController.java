...
public class AdminRestController {
    ...
    public ResponseEntity<ApiResponse<Object>> toggleUserStatus(@PathVariable Integer id) {
        // Lấy danh sách người dùng tạm thời để kiểm tra (có thể tối ưu bằng cách lấy trực tiếp từ DB)
        com.fivecore.jobportal.entity.User user = adminService.getUserById(id);
        if (user != null) {
    ...
    public ResponseEntity<Object> deleteUser(@PathVariable Integer id) {
        ...
        // Redirect về trang quản lý người dùng ở frontend (Sửa lại port nếu cần)
