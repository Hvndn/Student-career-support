...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeSampleStudents() {
        ...
        // Student 1: Hà Nội
        createStudent("nguyenvana@gmail.com", "Nguyễn Văn A", "Hà Nội", "Đại học Bách Khoa Hà Nội", "Công nghệ thông tin", "SV001", javaSkill);

        // Student 2: Hồ Chí Minh
        createStudent("tranvanb@gmail.com", "Trần Văn B", "Hồ Chí Minh", "Đại học Khoa học Tự nhiên", "Khoa học máy tính", "SV002", reactSkill);

        // Student 3: Đà Nẵng
        createStudent("lethic@gmail.com", "Lê Thị C", "Đà Nẵng", "Đại học Bách Khoa Đà Nẵng", "Hệ thống thông tin", "SV003", sqlSkill);
    ...
    private void createStudent(String email, String fullName, String location, String university, String major, String code, Skill skill) {
