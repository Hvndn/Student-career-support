...
public class CandidateSearchService {
     ...
     */
    public List<StudentProfileResponse> searchStudents(String queryStr, String location, String skill) {
        Specification<Student> spec = (root, query, cb) -> {
            ...
            if (location != null && !location.isEmpty() && !location.equalsIgnoreCase("Toàn quốc")) {
