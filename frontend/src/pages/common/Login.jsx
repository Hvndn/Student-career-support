            ...
            <div className="mr-auth-crystal-card">
                ...
                <div className="mr-auth-side-art">
                    ...
                    <div className="mr-art-content">
                        <h1>
                            Kiến tạo <span>Di sản</span> <br /> 
                            Sự nghiệp <span>Vươn tầm</span>
                        </h1>
                        <p className="mr-art-desc">
                            Gia nhập cộng đồng tinh hoa, nơi công nghệ và cơ hội hội tụ để bứt phá giới hạn nghề nghiệp của bạn.
                        </p>
                    </div>
                ...
                <div className="mr-auth-form-side">
                    <div className="mr-form-header">
                        <h2>Đăng nhập</h2>
                        <p>Tiếp tục hành trình chinh phục đỉnh cao</p>
                    </div>
