                    ...
                    <div className="stats-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
                        <div className="stat-card">
                            ...
                            <div className="stat-info">
                                <div className="stat-label" style={{ textTransform: 'uppercase', fontSize: '0.75rem', fontWeight: 700, color: '#94a3b8' }}>Tổng người dùng</div>
                                <div className="stat-value" style={{ fontSize: '2.5rem', fontWeight: 800 }}>{stats?.totalUsers?.toLocaleString() || '12,408'}</div>
                            </div>
                        </div>

                        <div className="stat-card">
                            <div className="stat-header">
                                <div className="stat-icon" style={{ background: '#f0f5ff', color: '#0d5cda' }}>
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                                </div>
                            </div>
                            <div className="stat-info">
                                <div className="stat-label" style={{ textTransform: 'uppercase', fontSize: '0.75rem', fontWeight: 700, color: '#94a3b8' }}>Xác minh doanh nghiệp</div>
                                <div className="stat-value" style={{ fontSize: '2.5rem', fontWeight: 800 }}>{stats?.totalCompanies || '42'}</div>
                                <div style={{ color: '#f59e0b', fontSize: '0.85rem', fontWeight: 600, marginTop: '0.5rem' }}>
                                    {stats?.pendingCompanies || '18'} đang chờ duyệt
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="stat-card">
                            ...
                            <div className="stat-info">
                                <div className="stat-label" style={{ textTransform: 'uppercase', fontSize: '0.75rem', fontWeight: 700, color: '#94a3b8' }}>Nội dung bị báo cáo</div>
                                <div className="stat-value" style={{ fontSize: '2.5rem', fontWeight: 800 }}>{stats?.totalReports?.toString().padStart(2, '0') || '07'}</div>
